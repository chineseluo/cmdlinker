...
class B(BaseCmd):
    def __init__(self, root_obj, pre_obj):
        ...
        self.meta_data = {'mapping_name': 'b', 'original_cmd': '-b', 'value': False, 'mutex': False, 'default': 'None', 'has_child_cmd': False, 'child_cmds': [], 'parent_cmd': 'Free', 'root_cmd': 'Free'}
        self.level = 2
        self.mutex = False
...
class T(BaseCmd):
    def __init__(self, root_obj, pre_obj):
        ...
        self.meta_data = {'mapping_name': 't', 'original_cmd': '-t', 'value': False, 'mutex': False, 'default': 'None', 'has_child_cmd': False, 'child_cmds': [], 'parent_cmd': 'Free', 'root_cmd': 'Free'}
        self.level = 2
        self.mutex = False
        self.need_value = False
        self.has_child_cmd = False
